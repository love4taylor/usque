...
func NewRequest(ctx context.Context, proxyTemplate *uritemplate.Template) (*Request, error) {
	return NewRequestWithOptions(ctx, proxyTemplate, requestProtocol, nil)
}

// NewRequestWithOptions creates a CONNECT-IP request with a custom protocol and headers.
func NewRequestWithOptions(ctx context.Context, proxyTemplate *uritemplate.Template, protocol string, headers http.Header) (*Request, error) {
